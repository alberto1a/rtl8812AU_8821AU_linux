...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	{USB_DEVICE(0x2357, 0x010D),.driver_info = RTL8812}, /* TP-Link - Archer T4U xAC1300 */
        {USB_DEVICE(0x2357, 0x0115),.driver_info = RTL8812}, /* TP-Link - Archer T4U AC1300 */
	{USB_DEVICE(0x2357, 0x010E),.driver_info = RTL8812}, /* TP-Link - Archer T4UH yAC1300 */
	...
	{USB_DEVICE(0x2001, 0x3314),.driver_info = RTL8821}, /* D-Link - dwa 171/
